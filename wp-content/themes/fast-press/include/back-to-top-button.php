...
add_action( 'customize_register', 'fast_press_back_to_top_customize_register' );
function fast_press_back_to_top_customize_register( $wp_customize ) {
/**************************************
 * Back to top button Options
***************************************/
		$wp_customize->add_section( 'back_to_top' , array(
			'title'       => __( 'Back To Top Button Options', 'fast-press' ),
			'priority'   => 98,
		) );
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'activate_back_to_top', array(
			'label'    => __( 'Activate Back To Top Button', 'fast-press' ),
			'section'  => 'back_to_top',
		...
		'label' => __('Button Color', 'fast-press'),        
		'section' => 'back_to_top',
		...
		'label' => __('Button Hover Color', 'fast-press'),        
		'section' => 'back_to_top',
		...
		'label' => __('Button Background Color', 'fast-press'),        
		'section' => 'back_to_top',
		...
		'label' => __('Button Background Hover Color', 'fast-press'),        
		'section' => 'back_to_top',
...
* Back to top styles
*********************************************/ 	
add_action( 'wp_enqueue_scripts', 'fast_press_back_top_method' );	
function fast_press_back_top_method() {
...
* Back to top
*********************************************/			
function fast_press_to_top() {
    echo '<a id="totop" href="#"><span class="dashicons dashicons-arrow-up-alt2"></span></a>';
    }
    add_action( 'wp_head', 'fast_press_back_to_top_style' );
    function fast_press_back_to_top_style() {
    echo '<style>
    #totop {
		position: fixed;
		right: 40px;
